...
public final class Class_d_023 extends Class_a_000 {
	...
	public final void sub_1e97(String[] paramArrayOfString,
		...
		this.var_100d += 32;
		if (this.var_100d > this.var_7a3) {
			this.var_100d = this.var_7a3;
		}
	...
	public final void sub_25e7() throws Exception {
		sub_2611(true);
	}
	...
	public final void sub_2611(boolean paramBoolean) throws Exception {
		...
		if ((paramBoolean) && (this.var_fd5 == 2)) {
			...
			if (this.var_105d == 15) {
				...
				if (i != 0) {
					var_fe5.sub_6260(this, this.var_111d, "", (byte) 0);
					return;
				}
				...
				if (Class_a_000.var_79b.sub_1f81(4)) {
					...
					this.var_102d %= this.var_1035;
					var_fe5.sub_6260(this, this.var_102d, null, (byte) 3);
					sub_1e13();
					this.var_106d = true;
				}
				...
				if (this.var_10b5 == 0) {
					...
					if ((this.var_105d != 7)
						...
						if (this.var_105d == 11) {
							...
							var_fe5.sub_6260(this, this.var_102d, null,
									(byte) 2);
							this.var_106d = true;
			...
			if ((this.var_fd5 == 2) && (this.var_fb5[1] != false)
				...
				var_fe5.sub_6260(this, -1, null, (byte) 1);
				return;
			}
		}
	...
	public final void sub_3652(Graphics paramGraphics) {
	...
	public final void sub_3675(Graphics paramGraphics, int paramInt1,
		...
		if (this.var_118d != null) {
			this.var_118d.sub_3652(paramGraphics);
		}
		...
		case 15:
			...
			paramGraphics.setClip(0, 0, var_fe5.var_32cb, var_fe5.var_32d3);
			if (this.var_119d > 0) {
			...
			for (int i8 = i6; i8 < i7; i8++) {
				...
				localClass_c_0321
						.sub_2551(
								...
								i12,
								i13,
								localClass_c_0321.var_b8b > var_fe5.var_35a3[var_fe5.var_357b]);
				if (i9 == this.var_102d) {
